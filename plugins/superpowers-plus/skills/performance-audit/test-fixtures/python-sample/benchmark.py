"""Representative workload driver — a real, runnable benchmark.

Drives the two request paths in app.py at representative sizes under cProfile so
hotspots can be measured rather than guessed.
