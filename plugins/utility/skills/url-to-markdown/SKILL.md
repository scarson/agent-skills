...
{
  "status": "success",
  "output_path": "/abs/path/2024-11-19-introducing-the-model-context-protocol.md",
  "metadata": {
    "title": "Introducing the Model Context Protocol",
    "author": null,
    "published": "2024-11-19",
    "source_url": "https://www.anthropic.com/news/model-context-protocol",
    "final_url": "https://www.anthropic.com/news/model-context-protocol",
    "fetched": "2024-11-19T08:00:00Z",
    "word_count": 777,
...
- 6 extraction tests against cached fixtures (anthropic.com, blogs.microsoft.com, MDN, arXiv, simonwillison.net, raw GitHub README)
...
- 4 YAML frontmatter round-trip regression tests (`_yaml_scalar` edge cases, all fixtures round-trip through PyYAML cleanly, real-page frontmatter round-trip, synthetic colon-in-description C1 regression test)
